...
class SessionAuth(Auth):
    ...
    def create_session(self, user_id: str = None) -> str:
        """creates a session
        This method generates a new session ID and associates it with the provided user ID.
        """
    ...
    def user_id_for_session_id(self, session_id: str = None) -> str:
        """returns a user id
        This method returns the user ID associated with the provided session ID.
        """
    ...
    def current_user(self, request=None):
        ...
        This method returns the User instance associated with the current session.
        """
